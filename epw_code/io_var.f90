  ...
  SAVE
  !
  PUBLIC :: lambda_phself, linewidth_phself, linewidth_elself,linewidth_elself_detail, iospectral, &
  ...
  INTEGER :: linewidth_elself= 62  ! Imaginary part of the electron self-energy
                                   ! [linewidth.elself] 
  INTEGER :: linewidth_elself_detail= 6020  ! Imaginary part of the electron self-energy
                                   ! [linewidth.elself_detail] 
