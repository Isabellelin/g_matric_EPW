  ...
  ELSE ! (iterative_bte .AND. epmatkqread)
    ...
    IF (elecselfen .OR. plselfen) THEN
      ...
      IF (iverbosity == 3) THEN
        ...
        IF (ierr /= 0) CALL errore('ephwann_shuffle', 'Error allocating sigmai_mode_detail', 1)
    ...
    IF (elecselfen .OR. plselfen) THEN
      ...
      IF (iverbosity == 3) THEN
        ...
        IF (ierr /= 0) CALL errore('ephwann_shuffle', 'Error deallocating sigmai_mode_detail', 1)
      ENDIF
    ENDIF
    IF (phonselfen) THEN
